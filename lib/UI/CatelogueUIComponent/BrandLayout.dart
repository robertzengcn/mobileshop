...
import 'package:amigatoy/UI/CatelogueUIComponent/catelogueDetail.dart';
    ...
    return MultiBlocProvider(
        providers: [
          BlocProvider<CategoriesBloc>(create: (context) {
            return CategoriesBloc(categoriesRepository: CategoriesRepository())
              ..add(ListcategoriesEvent(parentId: parentId));
          }),
        ],
      ...
      child: InkWell(
        onTap: () {
          if (categories.hasChild) {
            ...
            Navigator.of(context).push(
              PageRouteBuilder(
                  pageBuilder: (_, __, ___) =>
                      new brand(parentcategoriesId: categories.categoriesId),
            ...
            Navigator.of(context).push(
              PageRouteBuilder(
                  pageBuilder: (_, __, ___) => new catelogueDetail(categories),
                  transitionDuration: Duration(milliseconds: 600),
                  transitionsBuilder:
                      (_, Animation<double> animation, __, Widget child) {
                    return Opacity(
